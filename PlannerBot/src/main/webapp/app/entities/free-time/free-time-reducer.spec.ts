...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './free-time.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FREETIME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FREETIME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FREETIME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FREETIME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FREETIME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FREETIME actions', async () => {
      const arg = 42666;
